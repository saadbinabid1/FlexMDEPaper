...
Figure~\ref{fig:new_req} formalizes this high-level requirement in
...
as can be seen in figure~\ref{fig:glossary}\levi{correct this text because the
glossary pic is gone}.
...
Figure~\ref{fig:FAU_behavior_2d}\levi{correct the text for the empty table pic}
